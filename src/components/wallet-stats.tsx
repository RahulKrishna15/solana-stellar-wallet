  ...
  return (
    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
      <Card className="solana-card overflow-hidden">
        ...
        <CardContent>
          <div className="text-2xl font-bold">25.89 SOL</div>
          <p className="text-xs text-muted-foreground">
            ≈ $1,245.20 USD
          </p>
          <div className="mt-4 flex justify-between items-center">
            <Button className="solana-button-primary flex items-center gap-1 text-sm py-1" size="sm">
              Send <ArrowUp className="h-3 w-3" />
            </Button>
            <Button className="solana-button-secondary flex items-center gap-1 text-sm py-1" size="sm">
      ...
      <Card className="solana-card overflow-hidden">
        ...
        <CardContent>
          ...
          <div className="mt-4">
            <Button variant="outline" className="w-full border-solana-accent/20 hover:bg-solana-accent/10 transition-all duration-300 text-sm">
